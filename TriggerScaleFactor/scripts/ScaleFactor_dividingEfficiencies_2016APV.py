...
dataRootFile_2016B_ver1_HIPM = ROOT.TFile("2016APV/Run2016B_ver1_HIPM_DataHistos.root","READ")
dataDir__2016B_ver1_HIPM = dataRootFile_2016B_ver1_HIPM.GetDirectory("DataHistos")
...
dataRootFile_2016B_ver2_HIPM = ROOT.TFile("2016APV/Run2016B_ver2_HIPM_DataHistos.root","READ")
dataDir_2016B_ver2_HIPM = dataRootFile_2016B_ver2_HIPM.GetDirectory("DataHistos")
...
dataRootFile_2016C_HIPM = ROOT.TFile("2016APV/Run2016C_HIPM_DataHistos.root","READ")
...
dataRootFile_2016D_HIPM = ROOT.TFile("2016APV/Run2016D_HIPM_DataHistos.root","READ")
...
dataRootFile_2016E_HIPM = ROOT.TFile("2016APV/Run2016E_HIPM_DataHistos.root","READ")
...
dataRootFile_2016F_HIPM = ROOT.TFile("2016APV/Run2016F_HIPM_DataHistos.root","READ")
...
for i in range(1,47):
	if(mcNum.GetBinContent(i)>mcDeno.GetBinContent(i)):
		print("Error!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
		print(i," Deno = ",mcDeno.GetBinContent(i)," Num = ",mcNum.GetBinContent(i))
...
dataNum_2016B_ver1_HIPM.SetMaximum(dataDeno_2016B_ver1_HIPM.GetMaximum()+0.4*dataDeno_2016B_ver1_HIPM.GetMaximum())
