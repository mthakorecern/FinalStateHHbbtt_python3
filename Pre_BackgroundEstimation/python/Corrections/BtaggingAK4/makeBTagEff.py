...
parser.add_argument(
    '--wp',
    help="working points of DeepJetFlavB",
    choices=[
        "medium",
        "tight",
        "loose"],
...
# Select settings here. Filepaths to btag histograms are contained in
# BTagSampleList. MCsampleList contains path to MC samples (for cross
...
for histname, hist in list(hists.items()):
    if 'all' in histname:
        continue
