...
class addJecsMET(Module):
    ...
    def analyze(self, event):
        ...
        # This "sys" here has the "Up" and "Down" appended to it at the time of
        # function call
        def getJESMETpt(sys):
            # Total
            if sys == "Up":
...
def call_postpoc(files):
    ...
    AK4jetmetCorrectorUL2016MC = createJMECorrector(
        isMC=True, dataYear='UL2016', jesUncert="Merged", jetType="AK4PFchs")
    ...
    AK8jetmetCorrectorUL2016MC = createJMECorrector(
        isMC=True, dataYear='UL2016', jesUncert="Merged", jetType="AK8PFPuppi")
    ...
    AK4jetmetCorrectorUL2016preVFPMC = createJMECorrector(
        isMC=True, dataYear='UL2016_preVFP', jesUncert="Merged", jetType="AK4PFchs")
    ...
    AK8jetmetCorrectorUL2016preVFPMC = createJMECorrector(
        isMC=True, dataYear='UL2016_preVFP', jesUncert="Merged", jetType="AK8PFPuppi")
    ...
    AK4jetmetCorrectorUL2017MC = createJMECorrector(
        isMC=True, dataYear='UL2017', jesUncert="Merged", jetType="AK4PFchs")
    ...
    AK8jetmetCorrectorUL2017MC = createJMECorrector(
        isMC=True, dataYear='UL2017', jesUncert="Merged", jetType="AK8PFPuppi")
    ...
    AK4jetmetCorrectorUL2018MC = createJMECorrector(
        isMC=True, dataYear='UL2018', jesUncert="Merged", jetType="AK4PFchs")
    ...
    AK8jetmetCorrectorUL2018MC = createJMECorrector(
        isMC=True, dataYear='UL2018', jesUncert="Merged", jetType="AK8PFPuppi")
        ...
        if (search("Run", filename)):
            ...
            if (search("MET_Run2016F", filename)):
                ...
                p = PostProcessor(
                    ...
                    [files],
                    cut=preselection,
                    branchsel="Keep_Drop_txt/Data_keep_and_drop.txt",
                    modules=[
                    ...
                    noOut=False,
                    outputbranchsel="Keep_Drop_txt/Data_keep_and_drop_outputsel.txt")
            ...
            p = PostProcessor(
                ...
                [files],
                cut=preselection,
                branchsel="Keep_Drop_txt/MC_keep_and_drop.txt",
                modules=[
                ...
                postfix=post,
                noOut=False,
                outputbranchsel="Keep_Drop_txt/MC_keep_and_drop_outputsel.txt")
...
if __name__ == "__main__":
    ...
    # making a list of input MC files
    fnames_data = glob.glob(args.inputLocation + "/MET/*.root")
    ...
    heavyfiles_TTTsemi = glob.glob(
        args.inputLocation +
        "/TTToSemiLeptonic*.root")
    heavyfiles_TTT2l2nu = glob.glob(args.inputLocation + "/TTTo2L2Nu*.root")
    heavyfiles_wjets1200 = glob.glob(
        args.inputLocation +
        "/WJetsToLNu_HT-1200*.root")
    heavyfiles_wjets800 = glob.glob(
        args.inputLocation +
        "/WJetsToLNu_HT-800*.root")
    heavyfiles_wjets2500 = glob.glob(
        args.inputLocation +
        "/WJetsToLNu_HT-2500*.root")

    heavyfiles = heavyfiles_TTTsemi + heavyfiles_TTT2l2nu + \
        heavyfiles_wjets1200 + heavyfiles_wjets800 + heavyfiles_wjets2500
    ...
    print(("lighter files:",
           [(name.strip().split('/')[-1]).split('.')[-2] for name in fnames]))
    print("")
    print(("heavy files:", [(name.strip().split('/')
          [-1]).split('.')[-2] for name in heavyfiles]))
    print("")
    print(("Sanity check : Files before splitting heavy and light == ",
           (len(fnames_mc) + len(fnames_data)),
           "  Files after splitting : ",
           (len(fnames) + len(heavyfiles))))
    print("")
