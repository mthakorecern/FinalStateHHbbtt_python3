...
def main(args):
    ...
    extra_inputs = ",".join(filter(None, [
        ...
        args.vetomapjson,
        args.jercjson,
        args.jersmearjson if args.jersmearjson else "",
        helper,
    ]))
    ...
    commandList = [
        ...
        ] + ([f'--jersmearjson={os.path.basename(args.jersmearjson)}'] if args.jersmearjson else []) \
...
if __name__ == "__main__":
    ...
    parser.add_argument("--jersmearjson", default=None)
